...
void DNP2019_By(){
  ...
  TH2F *h = new TH2F("h","",50,50,100,50,30,80);
  ...
  if(infile.is_open()){
	...
	//
	if(N>=78 && N<=96 && Z<=60 && Z>=46){//only interested in certain nuclides here
	  //
	  //
	  //
	  ...
	  //yerrow == fast timing (232,196,63) => red
	  if(Z==3 && N==4)//7Li
